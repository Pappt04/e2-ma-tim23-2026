    ...
    Scaffold(
        ...
        Column(
            ...
            GAME_LIST.forEach { game ->
                OutlinedButton(
                    onClick = { /* TODO: navigate to individual game */ },
...
private data class GameInfo(val name: String, val description: String)

private val GAME_LIST = listOf(
    ...
    GameInfo("Korak po korak", "2 rounds · 140s · up to 40 pts"),
