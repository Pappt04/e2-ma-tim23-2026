...
interface MatchRepository {
    ...
    suspend fun sendFriendInvite(friendId: Long, friendly: Boolean): Result<MatchResponseDto>
    ...
    suspend fun respondToInvite(inviteId: Long, accept: Boolean): Result<MatchResponseDto>
    suspend fun cancelInvite(inviteId: Long): Result<Unit>
}
